                            ...
                            children: [
                              Column(
                                children: [
                                  ...
                                  controller.simulations[6].category.isNotEmpty
                                      ? ARGridTile(
                                          onTap: () async {
                                            subCategoryTitle = controller
                                          ...
                                          ellipse: gridTileDatas[6]['ellipse'],
                                        )
                                      : const SizedBox.shrink(),
                                ],
                              ),
                              ...
                              Column(
                                children: [
                                  ...
                                  controller.simulations[5].category.isNotEmpty
                                      ? ARGridTile(
                                          onTap: () async {
                                            subCategoryTitle = controller
                                          ...
                                          ellipse: gridTileDatas[5]['ellipse'],
                                        )
                                      : const SizedBox.shrink(),
                                  SizedBox(
                                    height: getWidgetHeight(height: 20),
                                  ),
                                  controller.simulations[7].category.isNotEmpty
                                      ? ARGridTile(
                                          onTap: () async {
                                            subCategoryTitle = controller
                                          ...
                                          ellipse: gridTileDatas[7]['ellipse'],
                                        )
                                      : const SizedBox.shrink(),
                                ],
                              ),
