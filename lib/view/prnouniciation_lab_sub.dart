                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Column(
                                      children: [
                                                            ...
                                                            : controller.errorPlaying ==
                                                                ...
                                                                : GestureDetector(
                                                                    ...
                                                                    child: controller.playingIs ==
                                                                        ...
                                                                        ? SizedBox(
                                                                            height:
                                                                                getWidgetHeight(height: displayWidth(context) > 500 ? 20 : 20),
                                                                            width:
                                                                                getWidgetWidth(width: displayWidth(context) > 500 ? 5 : 22),
                                                                            child:
                                                                                CircularProgressIndicator(
                                                                              strokeWidth: 2.0,
                                                                              color: linearColor,
                                                                ...
                                                                icon: SizedBox(
                                                                  ...
                                                                  child: controller
                                                                      ...
                                                                      : Image
                                                                          ...
                                                                          width:
                                                                              18,
                                                                          color: controller.isPriorityList[index]
                                                                              ? linearColor
                                                                              : Colors.black,
                                                                        ),
                                                                ),
                                                                ...
                                                                width:
                                                                    getWidgetWidth(
                                                                        width:
                                                                            180),
                                                                child: Text(
                                                                  controller.subcategories[index].pronun
                                                                              .trim() ==
                                                                          ""
                                                                      ? "no data"
                                                                      : controller
                                        ...
                                        if (controller.subcategories.length -
                                                1 ==
                                            index)
                                          SizedBox(
